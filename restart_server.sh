...
CHAT_MEMORY_DECISION_MAX_TOKENS="${CHAT_MEMORY_DECISION_MAX_TOKENS:-96}"
CHAT_MEMORY_DECISION_TIMEOUT_SECONDS="${CHAT_MEMORY_DECISION_TIMEOUT_SECONDS:-12}"

export CHAT_MEMORY_DECISION_MODEL
export CHAT_MEMORY_DECISION_MAX_TOKENS
...
echo "[restart] memory decision model=${CHAT_MEMORY_DECISION_MODEL}, max_tokens=${CHAT_MEMORY_DECISION_MAX_TOKENS}, timeout=${CHAT_MEMORY_DECISION_TIMEOUT_SECONDS}s"
